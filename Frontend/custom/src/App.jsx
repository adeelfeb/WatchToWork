...
function App() {
  ...
  const currencyObject = useCurrencyInfo(from);
  const currencyKeys = Object.keys(currencyObject || {}); // Fallback to an empty object if no data
  console.log(currencyObject);  // Check if it's fetching the data correctly
  console.log(currencyKeys);    // Ensure keys are populated
